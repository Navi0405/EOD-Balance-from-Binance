...
clients = [
    get_client('account1_key', 'account1_secret'),
    get_client('account2_key', 'account2_secret'),
    get_client('account3_key', 'account3_secret'),
    get_client('account4_key', 'account4_secret'),
    get_client('account4_key', 'account4_secret'),
    get_client('account5_key', 'account5_secret'),
    get_client('account6_key', 'account6_secret'),
    get_client('account7_key', 'account7_secret'),
    get_client('account8_key', 'account8_secret'),
    get_client('account9_key', 'account9_secret'),
    get_client('account10_key', 'account10_secret')
]

# Initialize Account Names
account_names = [
    "account1", "account2", "account3", "account4", "account4", 
